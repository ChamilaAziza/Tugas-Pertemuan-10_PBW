<?php 
  ...
  $query = "SELECT mahasiswa.nama AS 'nama_mhs' , matakuliah.nama AS 'nama_matkul', matakuliah.jumlah_sks FROM mahasiswa JOIN krs ON mahasiswa.npm = krs.mahasiswa_npm JOIN matakuliah ON matakuliah.kodemk = krs.matakuliah_kodemk ORDER BY mahasiswa.nPM ASC";
      ...
      <table class="table table-hover mt-4 table-striped">
        ...
        <?php
          ...
          <tr>
            ...
            <td>
            <?php echo "<font color='#008080'>".$result['nama_mhs']."</font>" . " Mengambil Mata Kuliah"."<font color='#008080'> ".$result['nama_matkul']."</font>" ." (".$result['jumlah_sks']." SKS)";?>
            </td>
          </tr>
          <?php
            }
