  ...
  <div class="container mt-5 pt-4">
    ...
    <figure class="text-dark">
      <blockquote class="blockquote">
        ...
        <p>Isi Data dengan Teliti dan Tepat</p>
      </blockquote>
    </figure>
    ...
    <div class="container text-dark mt-4">
      <form action="load-krs.php" method="POST">
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-5">
            <input required value="<?php echo $matakuliah_kodemk ?>" type="text" class="form-control shadow-sm bg-light rounded" id="inputKdMK" name="inputKdMK" placeholder="Cth: 001">
          </div>
        </div>
